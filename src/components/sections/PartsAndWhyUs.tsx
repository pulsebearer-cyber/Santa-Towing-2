    ...
    <section className="py-20 lg:py-28 bg-slate-50/70 relative border-t border-gray-200/60">
      <div className="max-w-7xl mx-auto px-4 md:px-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-14">
          ...
          <Link 
            to="/parts" 
            className="bg-primary hover:bg-secondary text-white px-7 py-3.5 rounded-[1px] font-bold transition-all inline-flex items-center gap-2 whitespace-nowrap shadow-md hover:-translate-y-0.5"
          >
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
          {PARTS_CATEGORIES.map((cat, idx) => (
            ...
            >
              ...
              >
                <div className="w-14 h-14 bg-primary/10 rounded-[1px] flex items-center justify-center mb-4 group-hover:bg-accent group-hover:shadow-md group-hover:shadow-accent/30 transition-all duration-300">
                  {getCategoryIcon(idx)}
                </div>
...
export function WhyChooseUs() {
  return (
    <section className="py-20 lg:py-28 bg-dark text-white relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-0 w-80 h-80 bg-accent/15 rounded-[1px] blur-[100px] pointer-events-none" />
      <div className="absolute bottom-1/4 right-0 w-80 h-80 bg-primary/20 rounded-[1px] blur-[100px] pointer-events-none" />

      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
        
        {/* Section Header */}
        <div className="text-center max-w-3xl mx-auto mb-16">
          <div className="inline-block px-3.5 py-1.5 bg-accent/20 text-accent font-bold rounded-[1px] text-xs uppercase tracking-wider mb-4 border border-accent/30">
            The Santa Advantage
          </div>
          ...
          {[
            ...
            return (
              <motion.div
                ...
                className="bg-white/5 border border-white/10 p-7 rounded-[1px] hover:border-accent/40 hover:bg-white/10 transition-all duration-300 group flex flex-col hover:-translate-y-1.5"
              >
                <div className="w-14 h-14 rounded-[1px] bg-accent/20 border border-accent/30 flex items-center justify-center mb-6 group-hover:bg-accent group-hover:shadow-lg group-hover:shadow-accent/30 transition-all duration-300">
        ...
        <div className="bg-gradient-to-r from-primary to-secondary p-8 sm:p-10 rounded-[1px] border border-white/10 shadow-2xl flex flex-col lg:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 shrink-0">
            <a 
              href="tel:0244753849" 
              className="bg-accent hover:bg-accent/90 text-white px-7 py-3.5 rounded-[1px] font-bold transition-all shadow-lg shadow-accent/30 hover:-translate-y-0.5 flex items-center gap-2 text-sm sm:text-base"
            >
            ...
            <Link 
              to="/towing" 
              className="bg-white/15 hover:bg-white/25 text-white px-7 py-3.5 rounded-[1px] font-bold transition-all border border-white/20 hover:-translate-y-0.5 text-sm sm:text-base"
            >
              Request Tow Online
            </Link>
          </div>
