...
export function FeaturedVehicles() {
  ...
  return (
    <section className="py-20 lg:py-28 bg-secondary text-white relative overflow-hidden">
      ...
      <div className="absolute top-0 right-0 w-96 h-96 bg-primary/20 rounded-[1px] blur-[100px] pointer-events-none" />
      <div className="absolute bottom-0 left-0 w-96 h-96 bg-accent/10 rounded-[1px] blur-[120px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-14">
          <div className="max-w-2xl">
            <div className="inline-block px-3.5 py-1.5 bg-white/10 text-white font-bold rounded-[1px] text-xs uppercase tracking-wider mb-4 border border-white/15">
          ...
          <div className="flex bg-white/10 p-1.5 rounded-[1px] backdrop-blur-md self-start md:self-end border border-white/15 overflow-x-auto no-scrollbar max-w-full">
            {tabs.map(tab => (
              <button
                ...
                className={cn(
                  "px-5 py-2 rounded-[1px] font-bold text-sm transition-all duration-200 whitespace-nowrap",
                  activeTab === tab 
            ...
            {filteredVehicles.map(vehicle => (
              ...
              >
                ...
                <div className="aspect-[4/3] relative overflow-hidden bg-black/40">
                  ...
                  />
                  {/* Ribbon Status Badge */}
                  <div className="absolute top-3 left-3 bg-accent text-white px-3 py-1 rounded-[1px] text-xs font-bold uppercase tracking-wider shadow-md flex items-center gap-1">
                    <Tag className="w-3 h-3" />
                    <span>For Sale</span>
                  </div>
                  {/* Year Badge */}
                  <div className="absolute top-3 right-3 bg-dark/80 backdrop-blur-md px-2.5 py-1 rounded-[1px] text-xs font-bold text-white border border-white/20">
                    {vehicle.year}
                  </div>
                </div>
        ...
        <div className="mt-12 text-center">
          <Link 
            to="/sales" 
            className="inline-flex items-center gap-2 bg-white/10 hover:bg-white/20 text-white px-8 py-3.5 rounded-[1px] font-bold transition-all border border-white/20 hover:border-white/40 group"
          >
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {RENTAL_CATEGORIES.map((category, idx) => (
            <motion.div
              ...
              className="bg-white rounded-[1px] overflow-hidden shadow-sm hover:shadow-xl border border-gray-200/80 hover:border-accent/30 transition-all duration-300 group flex flex-col hover:-translate-y-1.5"
            >
              {/* Category Image */}
              <div className="aspect-[16/10] relative overflow-hidden bg-gray-100">
                ...
                <div className="absolute top-4 left-4 bg-primary text-white px-3 py-1 rounded-[1px] text-xs font-bold uppercase tracking-wider shadow-sm">
                  Rental
                </div>
