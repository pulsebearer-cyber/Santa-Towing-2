                ...
                return (
                  <div key={category}>
                    <div className="flex items-center gap-3 mb-6">
                      <div className="w-10 h-10 bg-accent/10 rounded-[1px] flex items-center justify-center">
                    ...
                    <AnimatePresence>
                      {isOpen && (
                        ...
                        >
                          <div className="px-6 py-5 text-dark/80 border-t border-dark/10 leading-relaxed text-sm md:text-base">
                            <div className="mb-3">
                              <span className="inline-block bg-primary text-white text-[10px] font-bold tracking-wider uppercase px-2 py-1 rounded-[1px]">
                                {faq.category}
                              </span>
                            </div>
                            {faq.a}
      ...
      <section className="py-20 bg-white border-t border-dark/20">
        <div className="max-w-4xl mx-auto px-4 md:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <Link to="/contact" className="bg-primary hover:bg-black text-white px-8 py-4 rounded-[1px] font-bold transition-all shadow-xl flex items-center justify-center gap-2">
              <Phone className="w-5 h-5" /> Contact Support
            </Link>
            <a href="https://wa.me/233244753849" target="_blank" rel="noopener noreferrer" className="bg-primary/50 hover:bg-accent text-white px-8 py-4 rounded-[1px] font-bold transition-all shadow-xl flex items-center justify-center gap-2">
