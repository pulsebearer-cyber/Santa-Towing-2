    ...
    <main className="pt-24 lg:pt-[104px] min-h-screen">
      ...
      <section className="relative bg-primary overflow-hidden pt-12 pb-32 md:pt-20 md:pb-40">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8 text-center">
          ...
          >
            <Link to="/booking" className="bg-accent hover:bg-accent/90 text-white px-8 py-4 rounded-[1px] font-bold transition-all shadow-lg shadow-accent/30 flex items-center justify-center">
              Book for Repair
            </Link>
            <a href="tel:0244753849" className="bg-white/10 hover:bg-white/20 text-white backdrop-blur-md px-8 py-4 rounded-[1px] font-bold transition-all border border-white/20 flex items-center justify-center gap-2">
                ...
                >
                  ...
                  <div className="mt-auto pt-4 border-t border-dark/10 space-y-2">
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                      <Link to="/booking" className="flex-1 bg-primary hover:bg-black text-white text-center py-2 px-2.5 rounded-[1px] text-xs font-bold transition-all flex items-center justify-center">
          ...
          <div className="relative">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-6">
              {HOW_IT_WORKS.map((step, idx) => (
                ...
                >
                  <div className="w-12 h-12 md:w-16 md:h-16 bg-white rounded-[1px] border-4 border-white shadow-lg flex items-center justify-center text-lg md:text-xl font-bold text-dark group-hover:border-accent group-hover:text-accent transition-colors relative z-10 mb-4">
                    {idx + 1}
                  </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {MAINTENANCE_PACKAGES.map((pkg, idx) => (
              <motion.div
                ...
                transition={{ delay: idx * 0.1 }}
                className={cn(
                  "rounded-[1px] p-8 flex flex-col shadow-sm transition-transform hover:-translate-y-2",
                  pkg.popular ? "bg-primary text-white shadow-xl relative" : "bg-white border border-dark/10"
                )}
              >
                {pkg.popular && (
                  <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-accent text-white px-4 py-1 rounded-[1px] text-xs font-bold uppercase tracking-wider">
                    Most Popular
                  </div>
                )}
                ...
                <button className={cn(
                  "w-full py-4 rounded-[1px] font-bold transition-all mt-auto",
          ...
          <div className="max-w-2xl bg-primary rounded-[1px] p-8 md:p-12 shadow-2xl">
            ...
            <form className="space-y-4" onSubmit={e => e.preventDefault()}>
              ...
              <div className="flex flex-col sm:flex-row gap-3 pt-2">
                ...
                <a href="tel:0244753849" className="flex-1 bg-white hover:bg-white/90 text-dark font-bold py-4 rounded-[1px] transition-all shadow-lg flex items-center justify-center gap-2 text-center">
        ...
        <div className="flex gap-4 overflow-x-auto no-scrollbar pb-8 px-4 md:px-8 snap-x">
          {[
            ...
            <motion.div 
              ...
              viewport={{ once: true }}
              transition={{ delay: idx * 0.1 }}
              className="w-[300px] md:w-[450px] aspect-[4/3] shrink-0 rounded-[1px] overflow-hidden snap-center"
            >
      ...
      <section className="py-24 bg-primary text-white text-center relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <Link to="/booking" className="bg-primary hover:bg-black text-white px-8 py-4 rounded-[1px] font-bold transition-all shadow-xl flex items-center justify-center">
              Book for Repair
            </Link>
            <a href="tel:0244753849" className="bg-accent hover:bg-accent/90 text-white px-8 py-4 rounded-[1px] font-bold transition-all shadow-xl flex items-center justify-center gap-2">
              <Phone className="w-4 h-4" />
              <span>Call for Repair</span>
            </a>
          </div>
