      ...
      <section className="relative bg-primary overflow-hidden pt-12 pb-32 md:pt-20 md:pb-40">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-8">
          ...
          <motion.div 
            ...
            className="bg-white rounded-[1px] p-6 md:p-8 shadow-2xl relative translate-y-16 md:translate-y-24 max-w-5xl"
          >
            <form className="grid grid-cols-1 md:grid-cols-5 gap-4 items-end" onSubmit={e => e.preventDefault()}>
              <div className="md:col-span-1">
                ...
                <div className="relative">
                  ...
                  <input type="text" placeholder="Pickup location" className="w-full pl-10 pr-4 py-3 bg-white border border-dark/20 rounded-[1px] focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent" />
                </div>
              </div>
              <div className="md:col-span-1">
                ...
                <div className="relative">
                  ...
                  <input type="date" className="w-full pl-10 pr-4 py-3 bg-white border border-dark/20 rounded-[1px] focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent text-dark/70" />
                </div>
              </div>
              <div className="md:col-span-1">
              ...
              <div className="md:col-span-1">
                ...
                <div className="relative">
                  ...
                  <select className="w-full pl-10 pr-4 py-3 bg-white border border-dark/20 rounded-[1px] focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent appearance-none text-dark/70">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            {RENTAL_CATEGORIES.map((category, idx) => (
              <motion.div
                ...
                className="bg-white rounded-[1px] overflow-hidden shadow-sm hover:shadow-xl border border-dark/10 transition-all group flex flex-col"
              >
                ...
                <div className="p-6 flex-1 flex flex-col">
                  ...
                  <button className="w-full bg-white hover:bg-accent hover:text-white text-dark py-4 rounded-[1px] font-bold transition-colors">
                    View Vehicles
                  </button>
                </div>
              </motion.div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
            ...
            <div className="flex bg-white p-1 rounded-[1px] border border-dark/20 overflow-x-auto no-scrollbar max-w-full">
              {categories.map(tab => (
                <button
                  key={tab}
            ...
            <AnimatePresence mode="popLayout">
              {filteredVehicles.map((vehicle) => (
                <motion.div
                  ...
                  key={vehicle.id}
                  className="bg-white rounded-[1px] overflow-hidden border border-dark/20 hover:shadow-xl transition-all group flex flex-col"
                >
                  ...
                  <div className="p-6 flex-1 flex flex-col">
                    ...
                    <div className="flex gap-2 mt-auto">
                      ...
                      <button className="flex-1 bg-accent hover:bg-accent/90 text-white py-3 rounded-[1px] font-bold transition-colors text-sm shadow-md">
                        Book Now
                      </button>
                    </div>
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="grid lg:grid-cols-2 gap-16">
            <div>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="w-12 h-12 bg-accent/10 rounded-[1px] flex items-center justify-center shrink-0">
            ...
            <div>
              ...
              <div className="space-y-6">
                <div className="flex gap-4">
                  <div className="w-12 h-12 bg-white rounded-[1px] flex items-center justify-center shrink-0">
            ...
            {ADD_ONS.map((addon, idx) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: idx * 0.05 }}
                  className="bg-white rounded-[1px] p-6 shadow-sm border border-dark/10 text-center hover:border-accent hover:shadow-md transition-all group"
                >
