  ...
  return (
    <main className="pt-24 lg:pt-[104px] min-h-screen bg-white">
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-20">
          <div className="max-w-3xl">
            <motion.div
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-[1px] bg-white/10 backdrop-blur-md border border-white/20 text-accent font-bold text-sm tracking-wider uppercase mb-6"
            >
            ...
            >
              <button className="bg-accent hover:bg-accent/90 text-white px-8 py-4 rounded-[1px] font-bold transition-all shadow-lg shadow-accent/20">
                Request a Fleet Consultation
              </button>
              <button className="bg-white/10 hover:bg-white/20 backdrop-blur-md text-white border border-white/20 px-8 py-4 rounded-[1px] font-bold transition-all">
            ...
            {FLEET_SERVICES.map((service, idx) => {
              ...
              return (
                <motion.div 
                  ...
                  className="bg-white rounded-[1px] p-8 border border-dark/10 hover:shadow-xl transition-all group"
                >
                  <div className="w-14 h-14 bg-white rounded-[1px] flex items-center justify-center mb-6 shadow-sm group-hover:bg-accent transition-colors">
      ...
      <section className="py-20 bg-primary text-white relative overflow-hidden">
        <div className="absolute top-0 right-0 w-96 h-96 bg-primary/10 blur-[100px] rounded-[1px]" />
        <div className="absolute bottom-0 left-0 w-96 h-96 bg-primary/10 blur-[100px] rounded-[1px]" />
            ...
            {WHY_CHOOSE_US_FLEET.map((item, idx) => {
              ...
              return (
                <div key={idx} className="flex flex-col items-center text-center p-6 bg-white/5 border border-white/10 rounded-[1px] backdrop-blur-sm">
                  <div className="w-16 h-16 bg-white/10 rounded-[1px] flex items-center justify-center mb-4 text-primary">
            ...
            <div className="grid lg:grid-cols-5 gap-8 lg:gap-4 relative z-10">
              {STEPS.map((step, idx) => (
                <div key={idx} className="bg-white p-6 rounded-[1px] border border-dark/10 shadow-xl shadow-charcoal/5 relative">
                  <div className="w-12 h-12 bg-accent text-white font-bold rounded-[1px] flex items-center justify-center mb-6 shadow-lg shadow-charcoal/20">
                    {step.step}
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-16">
            ...
            <div className="w-full lg:w-1/2 relative">
              <div className="absolute inset-0 bg-primary/20 blur-[100px] rounded-[1px]" />
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-primary/80 to-transparent flex items-end p-6">
                     <div className="bg-white/90 backdrop-blur-sm p-4 rounded-[1px] shadow-lg w-full max-w-sm">
                       <div className="flex justify-between items-center mb-4">
                         ...
                         <span className="text-accent font-bold text-sm bg-primary/5 px-2 py-1 rounded-[1px]">98% Good</span>
                       </div>
      ...
      <section className="py-20 bg-primary text-white text-center">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <button className="bg-primary hover:bg-black text-white px-8 py-4 rounded-[1px] font-bold transition-all shadow-xl text-lg">
              Request a Consultation
            </button>
            <button className="bg-white hover:bg-dark/5 text-dark px-8 py-4 rounded-[1px] font-bold transition-all shadow-xl text-lg">
              Contact Sales
            </button>
          </div>
        </div>
