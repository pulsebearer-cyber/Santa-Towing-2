              ...
              return (
                ...
                >
                  ...
                  <div className="p-6 sm:p-8 flex-1 flex flex-col relative z-10 bg-white">
                    <div className="absolute -top-10 right-6 sm:right-8 w-14 h-14 bg-primary text-white rounded-[1px] flex items-center justify-center shadow-lg group-hover:bg-accent transition-colors duration-300">
      ...
      <section className="py-24 bg-primary text-white">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-dark/70 text-lg">Excellence and reliability in every interaction.</p>
          </div>
          ...
          <div className="relative">
            ...
            <div className="grid md:grid-cols-5 gap-8">
              {PROCESS_STEPS.map((step, idx) => (
                ...
                >
                  <div className="w-16 h-16 bg-white rounded-[1px] border-4 border-white shadow-xl flex items-center justify-center text-xl font-bold text-dark group-hover:bg-accent group-hover:text-white transition-colors relative z-10">
                    {idx + 1}
                  </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="bg-primary rounded-[1px] overflow-hidden flex flex-col md:flex-row relative">
            <div className="md:w-1/2 p-8 md:p-16 flex flex-col justify-center relative z-10 text-white">
              <div className="inline-flex items-center gap-2 px-4 py-1.5 bg-primary/20 text-accent font-bold rounded-[1px] text-xs uppercase tracking-wider mb-6 self-start">
                Featured Service
              </div>
              ...
              <button className="bg-accent hover:bg-accent/90 text-white px-8 py-4 rounded-[1px] font-bold transition-all shadow-lg self-start">
                Request a Tow Now
              </button>
            </div>
