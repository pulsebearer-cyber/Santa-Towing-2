...
export default function Parts() {
  ...
  return (
    <main className="pt-24 lg:pt-[104px] min-h-screen">
      ...
      <section className="relative z-20 -mt-12 mb-12 max-w-5xl mx-auto px-4 md:px-8">
        <div className="bg-white rounded-[1px] shadow-xl p-6 md:p-8 border border-dark/10 flex flex-col md:flex-row gap-4 items-center justify-between">
          ...
          <div className="flex-1 grid grid-cols-3 gap-3 w-full">
            <select className="bg-white border border-dark/20 rounded-[1px] px-4 py-3 text-dark/70 focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent appearance-none">
              <option>Make</option>
          ...
          <button className="w-full md:w-auto bg-primary hover:bg-black text-white px-6 py-3 rounded-[1px] font-bold transition-all">
            Find Parts
          </button>
        </div>
      </section>
            ...
            <div className="flex gap-2 overflow-x-auto pb-2 no-scrollbar">
              {['All', 'Batteries', 'Oil & Fluids', 'Tires'].map(cat => (
                <button 
                  ...
                  className={cn(
                    "px-6 py-2 rounded-[1px] font-bold text-sm whitespace-nowrap transition-colors",
                    activeCategory === cat 
              ...
              >
                <div className="aspect-[4/3] rounded-[1px] overflow-hidden mb-6 relative bg-white">
                  ...
                  <div className="absolute inset-0 bg-primary/40 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-3 backdrop-blur-sm">
                    <button className="w-12 h-12 bg-white rounded-[1px] flex items-center justify-center text-dark hover:bg-accent hover:text-white transition-colors shadow-lg" title="Quick View">
                      <Eye className="w-5 h-5" />
                    </button>
                    <button className="w-12 h-12 bg-accent text-white rounded-[1px] flex items-center justify-center hover:bg-accent transition-colors shadow-lg" title="Add to Cart">
