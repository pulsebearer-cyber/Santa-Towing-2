...
export default function BodyWorks() {
  ...
  return (
    <main className="pt-24 lg:pt-[104px] min-h-screen">
            ...
            {BODY_SERVICES.map((service, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="bg-white p-8 rounded-[1px] shadow-sm border border-dark/10 hover:shadow-xl transition-all group flex flex-col"
                >
                  <div className="w-14 h-14 bg-accent/10 rounded-[1px] flex items-center justify-center mb-6 group-hover:bg-accent transition-colors">
            ...
            <div className="bg-white/5 border border-white/10 rounded-[1px] p-4 md:p-8">
              <div className="flex justify-between items-center mb-6">
                ...
                <div className="flex gap-2">
                  <button 
                    ...
                    className="w-10 h-10 rounded-[1px] bg-white/10 hover:bg-accent text-white flex items-center justify-center transition-colors"
                  >
                    &larr;
                  </button>
                  <button 
              ...
              <div className="grid md:grid-cols-2 gap-4 md:gap-8 relative">
                <div className="relative rounded-[1px] overflow-hidden aspect-[4/3]">
                  ...
                  <div className="absolute top-4 left-4 bg-primary/80 text-white px-4 py-1.5 rounded-[1px] text-sm font-bold backdrop-blur-md">
                    Before
                  </div>
                </div>
                <div className="hidden md:flex absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-12 h-12 bg-accent text-white rounded-[1px] items-center justify-center z-10 shadow-xl border-4 border-dark">
            ...
            {WHY_CHOOSE_US.map((feature, idx) => {
              ...
              return (
                <motion.div
                  ...
                  viewport={{ once: true }}
                  transition={{ delay: idx * 0.1 }}
                  className="bg-white border border-dark/10 rounded-[1px] p-6 text-center hover:shadow-md transition-shadow"
                >
                  <div className="w-16 h-16 bg-white rounded-[1px] flex items-center justify-center mx-auto mb-4 shadow-sm text-primary">
          ...
          <div className="relative max-w-5xl mx-auto">
            ...
            <div className="grid grid-cols-2 md:grid-cols-6 gap-6">
              {HOW_IT_WORKS.map((step, idx) => (
                ...
                >
                  <div className="w-12 h-12 bg-white rounded-[1px] border-4 border-dark/10 shadow-md flex items-center justify-center font-bold text-dark group-hover:border-accent group-hover:text-accent transition-colors relative z-10 mb-4">
                    {idx + 1}
                  </div>
      ...
      <section className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="bg-primary rounded-[1px] p-8 md:p-12 overflow-hidden relative flex flex-col md:flex-row items-center gap-12">
            <div className="absolute top-0 right-0 w-64 h-64 bg-primary/20 rounded-[1px] blur-[80px]" />
            <div className="md:w-1/2 relative z-10">
              <div className="w-16 h-16 bg-white/10 rounded-[1px] flex items-center justify-center mb-6">
              ...
              <button className="bg-accent hover:bg-accent/90 text-white font-bold px-8 py-4 rounded-[1px] transition-all shadow-md">
      ...
      <section className="py-24 bg-white text-center">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <h2 className="text-3xl md:text-4xl font-bold text-dark mb-16">
            Flawless Results, Happy Customers
          </h2>
          
          <div className="grid md:grid-cols-3 gap-8">
            {[
              { text: "My car had a massive dent on the side door. Santa Towing fixed it and matched the metallic paint so perfectly, you can't even tell it was ever damaged.", author: "James F.", role: "Dent Repair" },
              { text: "I brought in my classic car for rust treatment and a full respray. The attention to detail was incredible, and the showroom finish is breathtaking.", author: "Sarah M.", role: "Full Restoration" },
              { text: "They made the insurance claim process so easy after my minor accident. The bumper looks brand new, and they delivered it right on schedule.", author: "David A.", role: "Accident Repair" },
            ].map((item, idx) => (
              <motion.div 
                key={idx}
                initial={{ opacity: 0, y: 20 }}
              ...
              >
                ...
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 bg-white rounded-[1px] overflow-hidden shrink-0">
                    <img src={`https://i.pravatar.cc/150?img=${idx * 4 + 20}`} alt="User" />
                  </div>
                  <div>
