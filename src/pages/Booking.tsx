    ...
    return (
      <main className="pt-24 lg:pt-[104px] min-h-screen bg-white">
        <div className="max-w-3xl mx-auto px-4 md:px-8 py-20 text-center">
          <div className="w-24 h-24 bg-primary/10 rounded-[1px] flex items-center justify-center mx-auto mb-8">
          ...
          <div className="bg-white rounded-[1px] p-8 border border-dark/10 shadow-sm mb-8 text-left max-w-xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            <button className="bg-primary hover:bg-black text-white px-8 py-4 rounded-[1px] font-bold transition-all shadow-md flex items-center justify-center gap-2">
              <CalendarPlus className="w-5 h-5" /> Add to Calendar
            </button>
            <Link to="/" className="bg-white hover:bg-dark/5 text-dark border border-dark/20 px-8 py-4 rounded-[1px] font-bold transition-all shadow-sm">
              Return Home
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 md:px-8">
            ...
            <div className="flex justify-between relative">
              ...
              {[1, 2, 3, 4, 5].map((i) => (
                <div key={i} className="relative z-10 flex flex-col items-center gap-2">
                  <div className={cn(
                    "w-10 h-10 rounded-[1px] flex items-center justify-center font-bold text-sm transition-colors duration-500",
          ...
          <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-start mt-16 sm:mt-8">
            ...
            <div className="w-full lg:w-2/3">
              <div className="bg-white rounded-[1px] p-6 md:p-10 border border-dark/10 shadow-sm min-h-[500px] flex flex-col">
                ...
                <AnimatePresence mode="wait">
                        ...
                        {SERVICES.map((service) => {
                          ...
                          return (
                            <button
                              ...
                              className={cn(
                                "flex items-start gap-4 p-4 rounded-[1px] border-2 text-left transition-all",
                                isSelected 
                            ...
                            >
                              <div className={cn(
                                "w-12 h-12 rounded-[1px] flex items-center justify-center shrink-0 transition-colors",
                      ...
                      <div className="space-y-6">
                        <div className="grid md:grid-cols-3 gap-4">
                          <div className="space-y-2">
                            ...
                            <input 
                              ...
                              className="w-full bg-white border border-dark/20 rounded-[1px] px-4 py-3 text-dark focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent"
                            />
                          </div>
                          <div className="space-y-2">
                        ...
                        <div className="space-y-2">
                          ...
                          <textarea 
                            ...
                            className="w-full bg-white border border-dark/20 rounded-[1px] px-4 py-3 text-dark focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent resize-none"
                          ></textarea>
                        </div>
                      </div>
                    </motion.div>
                  ...
                  {step === 4 && (
                    ...
                    >
                      ...
                      <div className="space-y-6">
                        ...
                        <div className="bg-primary/10 rounded-[1px] p-4 flex items-start gap-3 border border-primary/20">
                  ...
                  {step === 5 && (
                    ...
                    >
                      ...
                      <div className="space-y-6">
                        <div className="bg-white rounded-[1px] p-6 border border-dark/20">
                        ...
                        <label className="flex items-start gap-3 cursor-pointer">
                          <input type="checkbox" className="mt-1 w-4 h-4 text-primary focus:ring-accent rounded-[1px] border-dark/30" required />
                          <span className="text-sm text-dark/70">I agree to the <a href="#" className="text-accent hover:underline">Terms & Conditions</a> and <a href="#" className="text-accent hover:underline">Privacy Policy</a>.</span>
                        </label>
                      </div>
                    </motion.div>
                  )}
                ...
                <div className="flex items-center justify-between mt-auto pt-8 border-t border-dark/10">
                  <button 
                    onClick={handleBack}
                    className={cn(
                      "font-bold px-6 py-3 rounded-[1px] transition-all flex items-center gap-2",
                  ...
                  {step < 5 ? (
                    <button 
                      onClick={handleNext}
                      disabled={!canProceed()}
                      className="bg-primary hover:bg-black text-white font-bold px-8 py-3 rounded-[1px] transition-all flex items-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed shadow-md"
                    >
                    ...
                    <button 
                      ...
                      className="bg-accent hover:bg-accent/90 text-white font-bold px-8 py-3 rounded-[1px] transition-all flex items-center gap-2 shadow-md shadow-accent/20"
                    >
            ...
            <div className="w-full lg:w-1/3 space-y-6">
              ...
              <div className="bg-primary text-white rounded-[1px] p-6 shadow-xl sticky top-32">
                ...
                <div className="space-y-4 text-sm mb-6">
                  ...
                  {details.make && (
                    <div className="flex justify-between items-start">
                      <span className="text-dark/70">Vehicle:</span>
                      <span className="font-bold text-right">{details.make} {details.model}</span>
                    </div>
                  )}
                  {dateTime.date && (
                    <div className="flex justify-between items-start">
                      <span className="text-dark/70">Date/Time:</span>
                      <span className="font-bold text-right">{dateTime.date} {dateTime.time}</span>
                    </div>
                  )}
                </div>

                <div className="bg-dark rounded-[1px] p-4 border border-white/20">
                  <p className="text-xs text-dark/70 mb-1">Estimated Cost</p>
                  <p className="font-bold text-xl text-white">Quote on Arrival</p>
                  <p className="text-[10px] text-dark/70 mt-2 leading-tight">
      ...
      <section className="py-20 bg-white border-t border-dark/20">
        <div className="max-w-7xl mx-auto px-4 md:px-8 flex flex-col lg:flex-row gap-12">
          ...
          <div className="w-full lg:w-2/3">
            ...
            <div className="space-y-4">
              {FAQS.map((faq, idx) => (
                <div key={idx} className="border border-dark/20 rounded-[1px] overflow-hidden bg-white">
                  <button 
          ...
          <div className="w-full lg:w-1/3">
            <div className="bg-primary text-white rounded-[1px] p-8 shadow-xl relative overflow-hidden">
              <div className="absolute -bottom-10 -right-10 w-32 h-32 bg-white/20 rounded-[1px] blur-[20px]" />
              ...
              <div className="space-y-4 relative z-10">
                <a href="tel:0244753849" className="flex items-center gap-4 bg-primary hover:bg-black p-4 rounded-[1px] transition-colors">
                  <div className="w-10 h-10 bg-white/10 rounded-[1px] flex items-center justify-center">
                    <Phone className="w-5 h-5" />
                  </div>
                  <div>
                    <div className="text-xs text-dark/70">Call Us 24/7</div>
                ...
                <a href="https://wa.me/233244753849" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 bg-white text-dark hover:bg-white p-4 rounded-[1px] transition-colors">
                  <div className="w-10 h-10 bg-accent/10 text-accent rounded-[1px] flex items-center justify-center">
