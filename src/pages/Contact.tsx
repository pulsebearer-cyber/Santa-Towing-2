          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
            {CONTACT_OPTIONS.map((option, idx) => {
              ...
              return (
                ...
                >
                  <div className={cn("w-12 h-12 rounded-[1px] flex items-center justify-center mb-4 transition-colors", option.bg, option.color)}>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-16">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="w-full lg:w-3/5">
            <div className="bg-white rounded-[1px] p-8 md:p-12 border border-dark/10 shadow-sm">
              <h2 className="text-3xl font-bold text-dark mb-2">Send Us a Message</h2>
              <p className="text-dark/70 mb-8">Fill out the form below and our team will get back to you within 24 hours.</p>
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button 
                  ...
                  className="w-full bg-accent hover:bg-accent/90 text-white font-bold py-4 rounded-[1px] transition-all shadow-lg flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed"
                >
            ...
            {LOCATIONS.map((loc) => (
              <div key={loc.id} className="bg-white rounded-[1px] p-4 border border-dark/10 flex flex-col md:flex-row gap-6">
                ...
                <div className="w-full md:w-3/5 py-2 flex flex-col justify-center pr-4">
                  ...
                  <button className="bg-primary hover:bg-black text-white px-6 py-2 rounded-[1px] font-bold transition-colors text-sm self-start">
                    Get Directions
                  </button>
                </div>
              </div>
      ...
      <section className="py-20 bg-primary text-white text-center">
        <div className="max-w-3xl mx-auto px-4">
          ...
          <div className="flex flex-wrap justify-center gap-4">
            <a href="tel:0244753849" className="bg-primary hover:bg-black text-white px-8 py-4 rounded-[1px] font-bold transition-all shadow-xl flex items-center gap-2">
              <Phone className="w-5 h-5" /> Call Now
            </a>
            <a href="https://wa.me/233244753849" target="_blank" rel="noopener noreferrer" className="bg-white hover:bg-dark/5 text-[#25D366] px-8 py-4 rounded-[1px] font-bold transition-all shadow-xl flex items-center gap-2">
