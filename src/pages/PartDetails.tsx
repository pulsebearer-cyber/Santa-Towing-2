      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-8 md:py-12">
        <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 relative">
          ...
          <div className="w-full lg:w-2/3">
              ...
              <div className="flex gap-4 overflow-x-auto no-scrollbar py-2">
                {PRODUCT.images.map((img, idx) => (
                  <button 
                    ...
                    className={cn(
                      "w-20 h-20 md:w-24 md:h-24 shrink-0 rounded-[1px] overflow-hidden border-2 transition-all",
            ...
            <div className="bg-primary rounded-[1px] p-8 md:p-12 text-white mb-12 relative overflow-hidden">
              <div className="absolute right-0 top-0 w-64 h-64 bg-primary/20 blur-[80px] rounded-[1px]" />
              <div className="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
                ...
                <button className="w-full md:w-auto bg-accent hover:bg-accent/90 text-white font-bold px-8 py-4 rounded-[1px] transition-all whitespace-nowrap shadow-lg">
                  Book Installation
                </button>
              </div>
            </div>
                  ...
                  <div key={idx} className="bg-white p-6 rounded-[1px] border border-dark/10 shadow-sm">
                    <div className="flex justify-between items-start mb-4">
                      <div className="flex items-center gap-3">
                        <div className="w-10 h-10 bg-white rounded-[1px] flex items-center justify-center font-bold text-dark/70">
          ...
          <div className="w-full lg:w-1/3">
            <div className="bg-white rounded-[1px] p-6 md:p-8 border border-dark/10 shadow-xl lg:sticky lg:top-32">
              ...
              <div className="flex items-center gap-2 mb-8">
                {PRODUCT.inStock ? (
                  <div className="flex items-center gap-1 text-accent font-bold text-sm bg-primary/5 px-3 py-1 rounded-[1px]">
                    <CheckCircle2 className="w-4 h-4" /> In Stock & Ready to Ship
                  </div>
                ) : (
                  <div className="flex items-center gap-1 text-accent font-bold text-sm bg-accent/5 px-3 py-1 rounded-[1px]">
              ...
              <div className="bg-white p-4 rounded-[1px] mb-6">
                ...
                <div className="space-y-2">
                  <select className="w-full bg-white border border-dark/20 rounded-[1px] px-3 py-2 text-sm text-dark/70 focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent appearance-none">
                    <option>Select Make</option>
                  </select>
                  <select className="w-full bg-white border border-dark/20 rounded-[1px] px-3 py-2 text-sm text-dark/70 focus:outline-none focus:border-accent focus:ring-1 focus:ring-accent appearance-none" disabled>
              ...
              <div className="space-y-3 mb-6">
                <button className="w-full bg-accent hover:bg-accent/90 text-white font-bold py-4 rounded-[1px] transition-all shadow-md flex items-center justify-center gap-2">
                  <ShoppingCart className="w-5 h-5" /> Add to Cart
                </button>
                <button className="w-full bg-primary hover:bg-black text-white font-bold py-4 rounded-[1px] transition-all shadow-md">
                  Get a Quote
                </button>
              </div>
