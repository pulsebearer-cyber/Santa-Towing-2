...
export const BLOG_POSTS = [
  { id: 1, title: 'Essential Summer Car Maintenance Tips', category: 'Maintenance Tips', excerpt: 'Keep your car running cool during the hot summer months with these simple checks.', image: 'https://i.ibb.co/1YFx5jQV/Image-10-Engine-Oil-and-Fluids-Maintenance.jpg' },
  { id: 2, title: 'What to Look for When Buying a Used Car', category: 'Vehicle Buying Guide', excerpt: 'A comprehensive guide to inspecting and test driving a pre-owned vehicle.', image: 'https://i.ibb.co/gZh5x06r/Image-1-Towing-Vehicle.jpg' },
  { id: 3, title: 'What to Do If Your Car Breaks Down', category: 'Road Safety', excerpt: 'Step-by-step instructions to keep yourself safe while waiting for a tow.', image: 'https://i.ibb.co/zVkLKHdN/Image-2-A-SUV-KIA-Sportage-2024-Ratio.png' },
];
